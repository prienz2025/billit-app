...
/**
 * 연장 결제 필요 데이터 요청 (연장 결제 위젯 초기화)
 * POST /payments/initialize-extend
 * Request: PaymentExtensionCalculateRequest
 * Response: PaymentExtendInitializeResponse
 */
exports.initializeExtendPayment = functions.https.onRequest(async (req, res) => {
